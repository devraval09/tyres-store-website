...
--
-- Host: 127.0.0.1:3306
-- Generation Time: Sep 14, 2023 at 06:29 PM
...
--
CREATE DATABASE IF NOT EXISTS `mobile_shop` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `mobile_shop`;
...
(1, 'Apple', 'icon/apple1.jpeg'),
(2, 'Samsung', 'icon/samsung1.jpg'),
(3, 'one +', 'icon/one plus logo (2).jpg');
...
(6, 2, 1, '1', 'raviraj', 'raviraj@gmail.com', 'alkachock', 'surendrangar'),
(7, 2, 1, '1', 'raviraj', 'raviraj@gmail.com', 'alkachock', 'surendrangar');
...
(3, 'Apple IPhone XS Max', 'product/xs.jpg', 1, '64 GB ROM16.51 cm (6.5 inch) Super Retina HD Display12MP + 12MP | 7MP Front CameraA12 Bionic Chip ProcessoriOS 13 Compatible', '109990'),
