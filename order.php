         ...
         <div class="container">
            ...
            <div class="row">
               <div class="col-md-10 offset-md-1">
                  ...
                  <form id="request" class="main_form" action="book-code.php" method="post">
                     <div class="row">
                        <div class="col-md-12 ">
                        ...
                        <div class="col-md-12">
                           <textarea class="contactus" type="text"  name="address">Address</textarea>
                        </div>
                        <div class="col-md-12 ">
                        ...
                        <div class="col-md-12">
                           <button class="send_btn" type="submit">Order</button>
                        </div>
